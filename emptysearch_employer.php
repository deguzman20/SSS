...
<tr id="record">
    ...
    <td style="width:12.5%"><?php echo $Dat_Cov?></td><br>
           ...
           <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header" style="background-color:#016194;">
                     ...
                     <h2 class="modal-title"><span class="glyphicon glyphicon-edit"></span> <font color="white">Edit</font></h2> 
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                           <button class="btn btn-success btn-block" id="btn-Update" type="submit" onclick="updateData(<?php echo $ID?>)"   data-dismiss="modal"><span class="glyphicon glyphicon-edit"  ></span> Edit</button>
                    </div>
                </div>
              </div>
           </div>
