...
$query ="SELECT * FROM  educationalassistanceloan";
                            ...
                            <div class="modal-dialog modal-lg">
                               <div class="modal-content">
                                   ...
                                   <div class="modal-body">    
                                      ...
                                      <div class="col-md-3">
                                         <b>Amount applied for</b><br><input type="text" disabled="disabled" id="amount<?php echo $ID?>" value="<?php echo $amount?>" class="form-control">
                                      </div>
                                  </div>
