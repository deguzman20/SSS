 ...
 <div class="container">
  <div class="row">
     <div class="col-md-12">
       ...
       <hr>
       <h4>You can now pay your SSS contribution and loan repayments online!</h4>
     </div>
  </div>
  <div class="row">
      <div class="col-md-12">
         <br><br>
          <div class="col-md-2"><img src="image/bancnet.jpg" class="img-responsive"/></div>
          <div class="col-md-10"><p>The First multi-bank payment gateway where you can transanct in a secure, real time invironment using your BancNet ATM card.</p></div>
       </div>
  </div>
  <div class="row">
      <div class="col-md-12">
         <br><br>
          <div class="col-md-2"><img src="image/unionbank.jpg" class="img-responsive"/></div>
          <div class="col-md-10"><p>UnionBank is a partnership among the Aboitiz Group, Insular Life and Social Security System.</p></div>
       </div>
  </div>
 </div>
</div>
